...
try:
    entered_password = str(int(st.sidebar.text_input("Digite a senha de administração:", type="password")))
    if pagina_selecionada == "🔍Consultas":
        if not entered_password:
            st.warning("Digite a senha da administração no sidebar")
        elif entered_password == senha_admin:
            st.title("🔍Consulta")
